        ...
        <main className="hero">
          ...
          <section className="hero-right">
            <div className="hero-image-wrap">
              ...
              <div className="floating-card card-candidates" onClick={() => navigate('/register')} role="button" tabIndex={0}>
              ...
              <div className="floating-card card-employers" onClick={() => navigate('/register')} role="button" tabIndex={0}>
